...
// ---------------- Dropdown Options ----------------
const categories = ["Widow", "Disabled", "Imam Masjid", "Poor/Needy", "Other"];
const services = ["House", "Rashan", "Tent", "Clothes", "Bed", "Financial Support", "Medical Support", "Other"];
...
const addressLabels = {
  ...
  const validateForm = () => {
    ...
    if (!form.applicationCategory) nextErrors.applicationCategory = "Required";
    if (form.applicationCategory === "Other" && !form.applicationCategoryOther) nextErrors.applicationCategoryOther = "Required";
  ...
  const handleSubmit = async () => {
    try {
      ...
      const docData = {
        ...
        applicationCategoryOther: form.applicationCategoryOther || null,
        requiredService: form.requiredService,
        requiredServiceOther: form.requiredServiceOther || null,
        name: form.name,
        ...
        ...uploadedFiles,  // only include URLs
 ...
 return review ? (
  <div className="general-container">
    ...
    <div className="review-section">
      ...
      <div className="review-field"><strong>Applicant Category:</strong> {form.applicationCategory} {form.applicationCategoryOther && `(${form.applicationCategoryOther})`}</div>
    ...
    <div className="general-container">
      <h2 style={{fontSize:40}}>General Application Form</h2>
          ...
          <div className="button-group">
            {categories.map((c) => (
              <button
                type="button"
                key={c}
                className={`btn-option ${form.applicationCategory === c ? "selected" : ""}`}
                onClick={() => setField("applicationCategory", c)}
              >
                {c}
              </button>
            ))}
          </div>
          {form.applicationCategory === "Other" && (
            <input
              placeholder="Specify Other"
              value={form.applicationCategoryOther}
              onChange={(e) => setField("applicationCategoryOther", e.target.value)}
              className="other-input"
            />
          )}
          <span className="error">{errors.applicationCategory || errors.applicationCategoryOther}</span>
        </div>
